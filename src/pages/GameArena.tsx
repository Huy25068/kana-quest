...
import { Ear, MousePointerClick, Puzzle, SlidersHorizontal, Trophy, Zap, type LucideIcon } from 'lucide-react'
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="4 mini-game luyện phản xạ – dữ liệu lấy từ phạm vi học bạn đã chọn."
        actions={
